...
Then change CMP analog input, and watch the change of LED.
    - CMP0_IN5 (Jump B52 on Elevator Tower) connected to VCC =3.3V (Jump B3 on Elevator Tower): LED RED on
    - CMP0_IN5 (Jump B52 on Elevator Tower) connected to GND (Jump B2 on Elevator Tower): LED RED off
